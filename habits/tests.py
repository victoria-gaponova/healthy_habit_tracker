...
class HabitModelTestCase(TestCase):
    def setUp(self):
        ...
        self.user = User.objects.create(email='testuser@example.com', chat_id='testchatid')
    ...
    def test_validators(self):
        ...
        with self.assertRaises(serializers.ValidationError):
            validate_related_habit_and_reward({'related_habit': 1, 'reward': 'Test Reward'})
        ...
        with self.assertRaises(serializers.ValidationError):
            validate_pleasant_habit({'is_pleasant_habit': True, 'reward': 'Test Reward'})
